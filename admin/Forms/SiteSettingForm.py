...
class SitesettingBasicForm(forms.ModelForm):
    class Meta:
        ...
        def clean_site_email(self):
            site_email = self.cleaned_date.get('site_email')
            if not site_email:
        ...
        def clean_twitter_url(self):
            ...
            if twitter_url and (
                not twitter_url.startswith('https://twitter.com/')
                or not twitter_url.startswith('https://x.com')
            ):
        ...
        def clean_logo(self):
            ...
            if logo:
                ...
                if ext not in ['png', 'jpg', 'jpeg']:
                    raise forms.ValidationError('File must be PNG, JPG, or JPEG')
